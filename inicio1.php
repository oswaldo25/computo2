...
.bgimg-1 {
  ...
  background-image: url("imagenes/prin.jpg");
  min-height: 100%;
}
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-button w3-wide">SICODE</a>
    ...
    <div class="w3-right w3-hide-small">
      ...
      <button onclick="document.getElementById('id01').style.display='block'" class="w3-bar-item w3-button"><i class="fa fa-user"></i> LOGIN</button>
    </div>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">SICODE</span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">SICODE</span><br>
    <span class="w3-large">Sistema de Control de Deportistas</span>
    <p>
    <!-- <a href="#about" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Entrar</a> -->
    <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">LOGIN</button>
    </p>
